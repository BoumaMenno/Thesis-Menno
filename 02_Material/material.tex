...
\end{equation}
\textbf{DEFINE $C^{i-1}$ AND $D^i = \partial C^{i-1}$}\\
...
\end{align}
\nomenclature[V]{$\Upsilon$}{The system mode descriptor}
...
\begin{figure}[h]
\centering
\includegraphics[width=.4\textwidth]{hybridalg.eps}\caption{The algorithm used to solve a hybrid system with impulsive effects depicted in a flowchart.} \label{fig:2hybridalg}
\end{figure}
