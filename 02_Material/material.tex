...
\nomenclature[S]{$(\cdot)_{j}$}{Related to reference trajectory $j$}%
\nomenclature[S]{$(\cdot)_{i}$}{Related to reference trajectory $i$}%
\nomenclature[S]{$(\cdot)_{k}$}{Related to reference trajectory $k$}%
