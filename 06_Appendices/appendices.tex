...
\centering
    \includegraphics[width=\textwidth]{snapsref/frame11.eps}
	\caption*{$t=0.666$}
\end{minipage}
\begin{minipage}[c]{.3\textwidth}
\centering
    \includegraphics[width=\textwidth]{snapsref/frame12.eps}
	\caption*{$t=0.733$}
\end{minipage}
\begin{minipage}[c]{.3\textwidth}
\centering
    \includegraphics[width=\textwidth]{snapsref/frame13.eps}
	\caption*{$t=0.800$}
\end{minipage}

\begin{minipage}[c]{.3\textwidth}
\centering
    \includegraphics[width=\textwidth]{snapsref/frame14.eps}
	\caption*{$t=0.866$}
\end{minipage}
\begin{minipage}[c]{.3\textwidth}
\centering
    \includegraphics[width=\textwidth]{snapsref/frame15.eps}
	\caption*{$t=0.933$}
\end{minipage}
\begin{minipage}[c]{.3\textwidth}
\centering
    \includegraphics[width=\textwidth]{snapsref/frame16.eps}
	\caption*{$t=1.000$}
\end{minipage}

\begin{minipage}[c]{.3\textwidth}
\centering
    \includegraphics[width=\textwidth]{snapsref/frame17.eps}
	\caption*{$t=1.066$}
\end{minipage}
\begin{minipage}[c]{.3\textwidth}
\centering
    \includegraphics[width=\textwidth]{snapsref/frame18.eps}
	\caption*{$t=1.133$}
\end{minipage}
\begin{minipage}[c]{.3\textwidth}
\centering
    \includegraphics[width=\textwidth]{snapsref/frame19.eps}
	\caption*{$t=1.200$}
\end{minipage}

\begin{minipage}[c]{.3\textwidth}
\centering
    \includegraphics[width=\textwidth]{snapsref/frame20.eps}
	\caption*{$t=1.266$}
\end{minipage}
\begin{minipage}[c]{.3\textwidth}
\centering
    \includegraphics[width=\textwidth]{snapsref/frame21.eps}
	\caption*{$t=1.333$}
\end{minipage}
\begin{minipage}[c]{.3\textwidth}
\centering
    \includegraphics[width=\textwidth]{snapsref/frame22.eps}
	\caption*{$t=1.400$}
\end{minipage}
...
\begin{minipage}[c]{.3\textwidth}
\centering
    \includegraphics[width=\textwidth]{snapspert/frame11.eps}
	\caption*{$t=0.666$}
\end{minipage}
\begin{minipage}[c]{.3\textwidth}
\centering
    \includegraphics[width=\textwidth]{snapspert/frame12.eps}
	\caption*{$t=0.733$}
\end{minipage}
\begin{minipage}[c]{.3\textwidth}
\centering
    \includegraphics[width=\textwidth]{snapspert/frame13.eps}
	\caption*{$t=0.800$}
\end{minipage}

\begin{minipage}[c]{.3\textwidth}
\centering
    \includegraphics[width=\textwidth]{snapspert/frame14.eps}
	\caption*{$t=0.866$}
\end{minipage}
\begin{minipage}[c]{.3\textwidth}
\centering
    \includegraphics[width=\textwidth]{snapspert/frame15.eps}
	\caption*{$t=0.933$}
\end{minipage}
\begin{minipage}[c]{.3\textwidth}
\centering
    \includegraphics[width=\textwidth]{snapspert/frame16.eps}
	\caption*{$t=1.000$}
\end{minipage}

\begin{minipage}[c]{.3\textwidth}
\centering
    \includegraphics[width=\textwidth]{snapspert/frame17.eps}
	\caption*{$t=1.066$}
\end{minipage}
\begin{minipage}[c]{.3\textwidth}
\centering
    \includegraphics[width=\textwidth]{snapspert/frame18.eps}
	\caption*{$t=1.133$}
\end{minipage}
\begin{minipage}[c]{.3\textwidth}
\centering
    \includegraphics[width=\textwidth]{snapspert/frame19.eps}
	\caption*{$t=1.200$}
\end{minipage}

\begin{minipage}[c]{.3\textwidth}
\centering
    \includegraphics[width=\textwidth]{snapspert/frame20.eps}
	\caption*{$t=1.266$}
\end{minipage}
\begin{minipage}[c]{.3\textwidth}
\centering
    \includegraphics[width=\textwidth]{snapspert/frame21.eps}
	\caption*{$t=1.333$}
\end{minipage}
\begin{minipage}[c]{.3\textwidth}
\centering
    \includegraphics[width=\textwidth]{snapspert/frame22.eps}
	\caption*{$t=1.400$}
\end{minipage}
\caption{Snapshots of the tracking behavior of the system in Section~\ref{sec:5sys}, tracking the reference trajectory in Section~\ref{sec:5track}.}\label{fig:apptrack}
\end{figure}
%% New chapter %%
%\pagestyle{fancyreport}
%\cleartooddpage
