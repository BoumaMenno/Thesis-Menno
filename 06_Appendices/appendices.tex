...
\begin{itemize}
    \item It is possible for a contact point when it goes from open to stick to immediately go to slip, through input or for example gravity. Is this a simultaneous event? Also, write proof that there exists a range of epsilon such that an impact away from this event will not cause it to happen.
