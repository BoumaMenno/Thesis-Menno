...
\nomenclature[F]{$\Delta$}{The linearization of the perturbed event time around zero perturbation}%
\nomenclature[A]{$o(.)$}{Higher order terms}%
\nomenclature[F]{$\Gb_{\zb,i}$}{Positive homogeneous jump gain for the perturbed state direction}%
\nomenclature[F]{$\Gb_{\vb,i}$}{Positive homogeneous jump gain for the perturbed input direction}%
...
\end{itemize}
\nomenclature[F]{$\Hb$}{The positive homogeneous jump gain}%
\nomenclature[V]{$\zb$}{The perturbed state direction}%
\nomenclature[V]{$\vb$}{The perturbed input direction}%
\nomenclature[F]{$\Ab$}{Linear state matrix}%
\nomenclature[F]{$\Bb$}{Linear input matrix}%
