...
\begin{align}
\zb(t,i) = \left.\frac{\partial\xb(t,i,\epsilon)}{\partial\epsilon}\right|_{\epsilon=0},\text{ and } \vb(t,i) = \left.\frac{\partial\ub(t,i,\epsilon)}{\partial\epsilon}\right|_{\epsilon=0}.
\end{align}
...
\begin{align}
\xb(t,i,\epsilon) &= \xb(t,i,0) + \epsilon\left.\frac{\partial\xb(t,i,\epsilon)}{\partial\epsilon}\right|_{\epsilon=0} + o(\epsilon),\\
...
\begin{align}
\dot{\zb}(t,i) = \Ab(t)\zb(t,i) +\Bb(t)\vb(t,i),
\end{align}
with
\begin{align}
\Ab &= D_1\fb^i(\alphab(t,i),\mub(t,i),t),\\
\Bb &= D_2\fb^i(\alphab(t,i),\mub(t,i),t),
\end{align}
...
\end{align}
where $\dot{\alphab}(t,i)$ is known from the tracked reference trajectory and $\dot{\zb}(t,i)$ is known from the sensitivity analysis performed on the system.

\subsection{Sensitivity analysis for the state reinitialization}
